<script lang="ts">
  ...
  type Service = { jp: string; title: string; line: string; detail: string; tags: string[] }
  ...
  const english = {
    ...
    book: 'Book a strategy call', email: 'Book a strategy call', whatsapp: 'Book via WhatsApp', emailCta: EMAIL, explore: 'Explore services', servicesLabel: 'Services', servicesHeading: 'What we do',
    services: [
      { jp: '技術', title: 'Technical SEO', line: 'The foundation everything else sits on.', detail: 'Crawl architecture, Core Web Vitals, structured data and indexation control. We find what is holding your site back and fix it at the code level, where the problem actually lives.', tags: ['Site audit', 'Schema markup', 'Speed engineering', 'Log analysis'] },
      { jp: '生成', title: 'GEO', line: 'Get cited by the answer engines.', detail: 'Generative Engine Optimization. We structure your content, entities and authority signals so ChatGPT, Perplexity and Google AI Overviews quote you by name when your buyers ask.', tags: ['Entity mapping', 'Answer-first content', 'Citation tracking', 'llms.txt'] },
      ...
      { jp: '広告', title: 'Paid Search', line: 'Buy the clicks you cannot win yet.', detail: 'Google Ads managed against the same keyword map as your organic strategy. One plan, two channels, no wasted spend while the organic work compounds.', tags: ['Account restructure', 'Landing pages', 'Feed optimization', 'Weekly reporting'] },
    ] as Service[],
  ...
  const portuguese = {
    ...
    book: 'Falar pelo WhatsApp', email: 'Agendar uma conversa por e-mail', whatsapp: 'Falar pelo WhatsApp', emailCta: PORTUGUESE_EMAIL, explore: 'Conheça os serviços', servicesLabel: 'Serviços', servicesHeading: 'O que fazemos',
    services: [
      { jp: '技術', title: 'SEO técnico e local', line: 'Faça sua empresa aparecer nas buscas certas.', detail: 'Google Perfil da Empresa, páginas de serviço e cidade, dados estruturados, Core Web Vitals, indexação e intenção local.', tags: ['Perfil da Empresa', 'Páginas locais', 'Dados estruturados', 'Indexação'] },
      { jp: '生成', title: 'GEO / visibilidade em respostas de IA', line: 'Seja lembrado quando alguém perguntar.', detail: 'Conteúdo, entidades, autoridade e FAQs estruturadas para ChatGPT, Perplexity e AI Overviews do Google — visibilidade em respostas de IA, não só nos resultados tradicionais.', tags: ['Entidades', 'Conteúdo para respostas', 'FAQs estruturadas', 'Citações'] },
      { jp: '開発', title: 'Sites e landing pages', line: 'Caminhos claros para WhatsApp e orçamento.', detail: 'Páginas rápidas, mobile-first e com mensagem clara, construídas para transformar busca em conversa e pedido de orçamento.', tags: ['Mobile-first', 'Landing pages', 'Performance', 'Conversão'] },
      { jp: '広告', title: 'Mídia paga', line: 'Acelere a demanda que ainda não é orgânica.', detail: 'Google Ads e Meta alinhados à busca orgânica, à intenção local, às conversões e ao custo por oportunidade.', tags: ['Google Ads', 'Meta', 'Intenção local', 'Custo por oportunidade'] },
    ] as Service[],
